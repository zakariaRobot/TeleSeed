...
--create by RoyalTeam ID CHANNEL : @ZakariaRasoli
...
local function description_rules(msg, nama)
   ...
   if data[tostring(msg.to.id)] then
      ...
      local sambutan = "سلام "..nama.."خوش اومدین به گروه  [ "..string.gsub(msg.to.print_name, "_", " ").." ]امیدوارم به قوانین گروه به خوبی عمل کنی"
      local text = sambutan.."\n"
      local receiver = get_receiver(msg)
